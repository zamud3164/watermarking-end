...
class HiDDenConfiguration():
    ...
    def __init__(self, H: int, W: int, message_length: int,
                 ...
                 adaptor_ssim_weight: float = 6,  # Default value
                 adaptor_psnr_weight: float = 0.75,  # Default value
                 adaptor_ber_weight: float = 1000):  # Default value
        self.H = H
        self.W = W
        ...
        self.adaptor_ssim_weight = adaptor_ssim_weight
        self.adaptor_psnr_weight = adaptor_psnr_weight
        self.adaptor_ber_weight = adaptor_ber_weight
